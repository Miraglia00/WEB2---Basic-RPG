...
if(isset($_POST['kills']) && isset($_POST['turns']) && isset($_SESSION['user'])) {
  ...
  $turns = $db->real_escape_string($_POST['turns']);
  $db->execute_query("INSERT INTO web2_saves(user_id, review, kills, turns, saved_at) VALUES ('$id', $review, '$kills', '$turns', NOW())");
